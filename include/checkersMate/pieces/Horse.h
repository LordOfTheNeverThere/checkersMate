...
public:
    ...
    std::set<Coordinates> possibleMoves(const Piece* lastPlayedPiece = nullptr) override; // TODO: Review implementation so that Coordinate function might be used for brevity
